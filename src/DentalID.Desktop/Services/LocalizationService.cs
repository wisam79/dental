...
public class Loc : ILocalizationService, INotifyPropertyChanged
{
    ...
    private void LoadStrings()
    {
        ...
        _strings["en"] = new Dictionary<string, string>
        {
            ...
            // Startup View
            ["Startup_AppName"] = "DENTAL ID",
            ["Startup_Tagline"] = "FORENSIC BOOT MONITOR",
            ["Startup_BootStages"] = "Boot Stages",
            ["Startup_Stage_Integrity"] = "Integrity Validation",
            ["Startup_Stage_Database"] = "Database Bring-up",
            ["Startup_Stage_AI"] = "AI Session Loading",
            ["Startup_SecurityEnvelope"] = "Security Envelope",
            ["Startup_SysInit"] = "System Initialization",
            ["Startup_SysInitDesc"] = "Live status for model loading and secure runtime startup.",
            ["Startup_SecureBoot"] = "Secure Boot",
            ["Startup_ModelGrid"] = "Model Loading Grid",
            ["Startup_TeethDetector"] = "Teeth Detector",
            ["Startup_PathologyDetector"] = "Pathology Detector",
            ["Startup_FeatureEncoder"] = "Feature Encoder",
            ["Startup_Model_Teeth"] = "Teeth detector",
            ["Startup_Model_Pathology"] = "Pathology detector",
            ["Startup_Model_Encoder"] = "Feature encoder",
            ["Startup_Status_Booting"] = "Booting Secure Runtime...",
            ["Startup_Status_Initializing"] = "Initializing System...",
            ["Startup_Status_Verifying"] = "Verifying System...",
            ["Startup_Status_Verified"] = "Integrity Verified.",
            ["Startup_Status_InitDatabase"] = "Initializing Database...",
            ["Startup_Status_DatabaseReady"] = "Database Ready.",
            ["Startup_Status_LoadingModels"] = "Loading AI Models...",
            ["Startup_Status_ValidatingModel"] = "Validating {0}...",
            ["Startup_Status_LoadingSessions"] = "Loading ONNX runtime sessions...",
            ["Startup_Status_ModelsLoaded"] = "AI models loaded successfully.",
            ["Startup_Status_SystemReady"] = "System Ready.",
            ["Startup_ModelsSummary"] = "{0}/3 models ready",
            ["Startup_State_Pending"] = "Pending",
            ["Startup_State_Validating"] = "Validating",
            ["Startup_State_Verified"] = "Verified",
            ["Startup_State_Loading"] = "Loading",
            ["Startup_State_Ready"] = "Ready",
            ["Startup_State_Error"] = "Error",

            // Error overlay
            ["Lab_Error_Title"] = "Analysis Failed",
            ["Lab_Error_Retry"] = "Retry",
            ["Lab_Saving_Title"] = "Saving Evidence...",
            ["Lab_Saving_Subtitle"] = "Encrypting and storing to database",
        };
        ...
        _strings["ar"] = new Dictionary<string, string>
        {
            ...
            // Startup View (Arabic)
            ["Startup_AppName"] = "DENTAL ID",
            ["Startup_Tagline"] = "مراقب الإقلاع الجنائي",
            ["Startup_BootStages"] = "مراحل الإقلاع",
            ["Startup_Stage_Integrity"] = "التحقق من النزاهة",
            ["Startup_Stage_Database"] = "تشغيل قاعدة البيانات",
            ["Startup_Stage_AI"] = "تحميل جلسة الذكاء الاصطناعي",
            ["Startup_SecurityEnvelope"] = "الغلاف الأمني",
            ["Startup_SysInit"] = "تهيئة النظام",
            ["Startup_SysInitDesc"] = "حالة مباشرة لتحميل النماذج والإقلاع الآمن.",
            ["Startup_SecureBoot"] = "إقلاع آمن",
            ["Startup_ModelGrid"] = "شبكة تحميل النماذج",
            ["Startup_TeethDetector"] = "كاشف الأسنان",
            ["Startup_PathologyDetector"] = "كاشف الأمراض",
            ["Startup_FeatureEncoder"] = "مشفّر الميزات",
            ["Startup_Model_Teeth"] = "كاشف الأسنان",
            ["Startup_Model_Pathology"] = "كاشف الأمراض",
            ["Startup_Model_Encoder"] = "مشفّر الميزات",
            ["Startup_Status_Booting"] = "بدء بيئة التشغيل الآمنة...",
            ["Startup_Status_Initializing"] = "جاري تهيئة النظام...",
            ["Startup_Status_Verifying"] = "التحقق من النظام...",
            ["Startup_Status_Verified"] = "تم التحقق من النزاهة.",
            ["Startup_Status_InitDatabase"] = "جاري تهيئة قاعدة البيانات...",
            ["Startup_Status_DatabaseReady"] = "قاعدة البيانات جاهزة.",
            ["Startup_Status_LoadingModels"] = "جاري تحميل نماذج الذكاء الاصطناعي...",
            ["Startup_Status_ValidatingModel"] = "التحقق من {0}...",
            ["Startup_Status_LoadingSessions"] = "جاري تحميل جلسات ONNX...",
            ["Startup_Status_ModelsLoaded"] = "تم تحميل النماذج بنجاح.",
            ["Startup_Status_SystemReady"] = "النظام جاهز.",
            ["Startup_ModelsSummary"] = "{0}/3 نماذج جاهزة",
            ["Startup_State_Pending"] = "قيد الانتظار",
            ["Startup_State_Validating"] = "جارٍ التحقق",
            ["Startup_State_Verified"] = "تم التحقق",
            ["Startup_State_Loading"] = "جارٍ التحميل",
            ["Startup_State_Ready"] = "جاهز",
            ["Startup_State_Error"] = "خطأ",

            // Error overlay (Arabic)
            ["Lab_Error_Title"] = "فشل التحليل",
            ["Lab_Error_Retry"] = "إعادة المحاولة",
            ["Lab_Saving_Title"] = "جاري حفظ الأدلة...",
            ["Lab_Saving_Subtitle"] = "تشفير وتخزين في قاعدة البيانات",
        };
    }
}
